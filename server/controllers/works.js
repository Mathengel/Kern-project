    ...
    create: function(req, res){
        ...
        if(req.body.type == "text"){
            var newTextWork = new TextWork({
                    ...
                    small: "https://s3-us-west-2.amazonaws.com/lengeltextures/small/" + req.body.image + "Small.jpg",
                    large: "https://s3-us-west-2.amazonaws.com/lengeltextures/large/" + req.body.image + "Large.jpg",
                    detail: "https://s3-us-west-2.amazonaws.com/lengeltextures/detail/" + req.body.image + "Detail.jpg",
